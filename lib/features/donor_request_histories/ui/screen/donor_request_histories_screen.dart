...
class DonorRequestHistoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CurrentUserDonorRequestBloc,
          CurrentUserDonorRequestState>(
        builder: (context, state) {
          if (state is CurrentUserDonorRequestLoaded) {
            List<DonorRequestModel> updatedRequests = state.donorRequests;
            return ListView(
              children: List.generate(
                requests.length,
                (index) {
                  DonorRequestModel request = updatedRequests[index];
